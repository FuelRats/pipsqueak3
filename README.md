...
If you would prefer to run the service locally, bear in mind you may need to run a local PostgreSQL Database or the provided sql service via docker-compose for the fact module.
