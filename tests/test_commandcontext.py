...
def test_create_manual_channel(bot_fx):
    trigger = CommandContext(bot_fx, ["don't", "care"], ["don't care", "care"], "test_nick",
                             "#somechannel",
...
def test_trigger_eq(bot_fx):
    trigger1 = CommandContext(bot_fx, ["some", "thing"], ["some thing", "thing"], "test_nick",
                              "not_a_channel", "test_ident", "test.vhost")
    trigger2 = CommandContext(bot_fx, ["some", "thing"], ["some thing", "thing"], "test_nick",
                              "not_a_channel", "test_ident", "test.vhost")
...
def test_trigger_ne(bot_fx):
    trigger1 = CommandContext(bot_fx, ["some", "thing"], ["some thing", "thing"], "test_nick",
                              "not_a_channel", "test_ident", "test.vhost")
    trigger2 = CommandContext(bot_fx, ["some", "thing"], ["another thing", "thing"], "stupid_nick",
...
def test_trigger_hash():
    trigger1 = CommandContext(None, ["some", "thing"], ["some thing", "thing"], "test_nick",
                              "not_a_channel", "test_ident", "test.vhost")
    trigger2 = CommandContext(None, ["some", "thing"], ["some thing", "thing"], "test_nick",
                              "not_a_channel", "test_ident", "test.vhost")
    trigger3 = CommandContext(None, ["some", "thing"], ["another thing", "thing"], "stupid_nick",
                              "not_a_channel", "test_ident", "go.away")
